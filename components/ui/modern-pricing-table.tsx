        ...
        <div className="w-full max-w-7xl mx-auto p-6 space-y-16">
            ...
            >
                ...
                >
                    ...
                    >
                        <TabsList className="flex w-full h-12 cursor-pointer bg-slate-100 rounded-lg p-1">
                            <TabsTrigger value="monthly" className="text-base font-medium cursor-pointer flex-1 px-3 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-md">Monthly</TabsTrigger>
                            <TabsTrigger value="yearly" className="text-base font-medium flex items-center gap-2 cursor-pointer flex-1 px-3 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-md text-slate-600">
                                Yearly
            ...
            >
              ...
              ${plan.isFeatured
                                ? 'border-indigo-500 bg-gradient-to-br from-indigo-50 to-violet-50 dark:border-indigo-400 shadow-xl'
                                : 'border-slate-200 bg-white/80 shadow-md backdrop-blur-xl hover:shadow-lg'
                            }
            `}>
                            {/* Plan Header */}
                            <div className="text-center space-y-4 mb-8">
                                ...
                                <div className="space-y-2">
                                    <div className="text-4xl font-bold text-slate-900 flex items-center justify-center">
                            ...
                            >
                                <Button
                                    ...
                                    size="lg"
                                    className={`w-full ${plan.isFeatured ? 'bg-indigo-600 hover:bg-indigo-700 text-white' : 'text-indigo-600 border-indigo-200 hover:bg-indigo-50'}`}
                                >
                                    <a href={plan.ctaHref}>
                                        {plan.ctaText}
                                    </a>
